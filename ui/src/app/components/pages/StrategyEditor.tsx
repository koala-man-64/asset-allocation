...
export function StrategyEditor({ strategy, open, onOpenChange }: StrategyEditorProps) {
    ...
    const { register, handleSubmit, reset, setValue, watch, formState: { errors } } = useForm<Strategy>({
        defaultValues: {
            name: '',
            type: 'configured',
            description: '',
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 py-4">
                    ...
                    <div className="space-y-4 border-t pt-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input id="universe" {...register('config.universe')} placeholder="SP500, NDX, etc." />
                        </div>
