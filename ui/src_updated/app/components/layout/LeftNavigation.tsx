        ...
        <div className="h-16 flex items-center px-4 border-b border-sidebar-border">
          {!collapsed ? (
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-sidebar-primary to-purple-600 flex items-center justify-center">
                <LayoutDashboard className="h-5 w-5 text-white" />
              </div>
              <span className="font-bold text-white text-base">QuantCore</span>
            </div>
          ) : (
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-sidebar-primary to-purple-600 flex items-center justify-center mx-auto cursor-pointer">
                  <LayoutDashboard className="h-5 w-5 text-white" />
                </div>
              </TooltipTrigger>
