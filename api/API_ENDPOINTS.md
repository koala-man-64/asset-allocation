...
└── /api
    ...
    │       └── /{job_name}/logs [GET] (system.job_logs) - Returns a scrollable console log slice (Log Analytics) :: api/endpoints/system.py <== ui/src/app/components/pages/system-status/JobLogDrawer.tsx
