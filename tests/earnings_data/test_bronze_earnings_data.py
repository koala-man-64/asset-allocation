...
def test_fetch_and_save_raw(unique_ticker):
    ...
    async def run_test():
        with patch('core.playwright_lib.get_yahoo_earnings_data', return_value=mock_df) as mock_get_data, \
             patch('tasks.earnings_data.bronze_earnings_data.list_manager') as mock_list_manager, \
