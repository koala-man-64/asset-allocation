...
from scripts.price_target_data import bronze_price_target_data as bronze
...
@patch('scripts.price_target_data.bronze_price_target_data.nasdaqdatalink')
@patch('scripts.price_target_data.bronze_price_target_data.bronze_client')
@patch('scripts.price_target_data.bronze_price_target_data.list_manager')
def test_process_batch_bronze(mock_list_manager, mock_client, mock_nasdaq, unique_ticker, storage_cleanup):
    ...
    async def run_test():
        ...
        with patch('scripts.common.core.store_raw_bytes') as mock_store:
