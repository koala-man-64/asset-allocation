...
from tasks.candlesticks import gold_candlesticks as gc
...
def test_compute_features_doji(sample_ohlcv_doji):
    ...
    # Assert Doji flag is set (based on default thresholds)
    # Body (0.05) / Range (10.0) = 0.005 <= 0.05 (default)
...
def test_process_ticker_flow():
    ...
    gold_path = "candlesticks/TEST_TICKER"
    ...
    with patch("core.delta_core.load_delta") as mock_load, patch("core.delta_core.store_delta") as mock_store:
