...
class DataPaths:
    ...
    @staticmethod
    def get_gold_candlesticks_path(ticker: str) -> str:
        """Per-ticker gold candlestick indicator table path."""
        return f"candlesticks/{ticker}"

    @staticmethod
    def get_gold_candlesticks_by_date_path() -> str:
        """Cross-sectional (by-date) gold candlestick indicator table path."""
        return "candlesticks_by_date"
