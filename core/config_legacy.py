...
# STRICT ENFORCEMENT: No defaults allowed.
...
AZURE_CONTAINER_RANKING = _require_env("AZURE_CONTAINER_RANKING")
AZURE_CONTAINER_BRONZE = _require_env("AZURE_CONTAINER_BRONZE")
AZURE_CONTAINER_SILVER = _require_env("AZURE_CONTAINER_SILVER")
