...
| `backtest-api` | `asset-allocation-backtest-api` | Configurable | 8000 | OIDC / API Key |
...
| `ACR_PASSWORD` | `docker/login` & ACA `secretRef` | Registry Pull Credentials | ✅ **Secure** (Injected as Secret) |
