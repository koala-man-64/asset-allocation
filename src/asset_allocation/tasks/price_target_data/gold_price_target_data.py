...
def _build_job_config() -> FeatureJobConfig:
    ...
    from asset_allocation.core import config as common_cfg
...
if __name__ == "__main__":
    ...
    from asset_allocation.tasks.price_target_data.materialize_gold_price_target_by_date import main as by_date_main
